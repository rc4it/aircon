from telegram import InlineKeyboardMarkup, InlineKeyboardButton, ParseMode, ReplyKeyboardMarkup, KeyboardButton, Message, Bot
...
def prompt_end_buttons(update, context):
    ...
    text2 = "The following are your current information: \nRoom Unit Number: " + room_unit_no + "\nEVS Username: " + evs_username + "\nLower Credit Limit: $" + lower_credit_limit + "\n\nYou can access our other functions here!"
