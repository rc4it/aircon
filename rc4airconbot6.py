...
def send_notification(update):
    string_bal = balance[18:22]
    no_bal = float(string_bal)

    update.message.reply_text(
        "Your credit balance is currently: $" + string_bal + ". You can top up at https://nus-utown.evs.com.sg/.",
    )
    return
...
def main():
    ...
    reset_time = datetime.time(hour=15, minute=43, second=0, tzinfo=time_zone)
